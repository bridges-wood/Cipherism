...
public class Tester {
	...
	public static void main(String[] args) {
		...
		String otherText = "";
		...
		//	System.out.println(entry.getKey() + ":" + entry.getValue());
		//}
		KasiskiExamination.kasiskiExam(NGramAnalyser.kasiskiBase(3, otherText), otherText);
	}
